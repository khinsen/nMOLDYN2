...
from Scientific.TkWidgets.TkPlotCanvas import PlotCanvas, PolyLine, \
     VerticalLine, PlotGraphics
...
class ScatteringFunctionPlot(Frame):
    ...
    def plot_objects(self, first_q, last_q, skip_q,
        ...
        for i in range(first_q, last_q, skip_q):
            ...
            points = Numeric.transpose(Numeric.array([data_t, data]))
        ...
        for i in range(first_t, last_t, skip_t):
            ...
            points = Numeric.transpose(Numeric.array([data_q, data]))
